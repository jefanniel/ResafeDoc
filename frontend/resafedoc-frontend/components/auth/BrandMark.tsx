/**
 * Mark kiri panel auth: menggunakan bahasa visual yang sama dengan Stamp
 * (cincin ganda, rotasi tetap) supaya terasa satu keluarga dengan halaman
 * hasil pindai — bukan ikon generik "welcome" yang tidak terkait produk.
 */
